...
/**
 * DxfGroup is a group containing a dxf code and a dxf value. The class contains
 * several utils to read and write groups an to format data.
 * 
...
public class DxfGroup {
    ...
    private static final DecimalFormat[] decimalFormats = new DecimalFormat[] { new DecimalFormat("#0", dfs), new DecimalFormat("#0.0", dfs), new DecimalFormat("#0.00", dfs),
            new DecimalFormat("#0.000", dfs), new DecimalFormat("#0.0000", dfs), new DecimalFormat("#0.00000", dfs), new DecimalFormat("#0.000000", dfs),
            new DecimalFormat("#0.0000000", dfs), new DecimalFormat("#0.00000000", dfs), new DecimalFormat("#0.000000000", dfs), new DecimalFormat("#0.0000000000", dfs),
            new DecimalFormat("#0.00000000000", dfs), new DecimalFormat("#0.000000000000", dfs) };
    ...
    public DxfGroup(String code, String value) {
        try {
            ...
            System.out.println("Error reading group: \"" + code + "=" + value + "\" is not a valid code/value pair");
        }
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof DxfGroup && code == ((DxfGroup) other).getCode() && value.equals(((DxfGroup) other).getValue())) {
            return true;
        } else
            return false;
    }
