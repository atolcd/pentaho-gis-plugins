...
/**
 * The STYLE item in the TABLES section There is a static reader to read the
 * item from a DXF file and a toString method to write it in the DXF format
 * 
...
public class DxfTABLE_STYLE_ITEM extends DxfTABLE_ITEM {
    ...
    public DxfTABLE_STYLE_ITEM(String name, int flags, float textHeight, float widthFactor, float obliqueAngle, int textGenerationFlags, float lastHeightUsed,
            String primaryFontFileName, String bigFontFileName) {
        super(name, flags);
