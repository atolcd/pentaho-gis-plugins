package com.atolcd.pentaho.di.ui.trans.steps.gisgroupby;
...
import com.atolcd.pentaho.di.trans.steps.gisgroupby.GisGroupByMeta;

public class GisGroupByDialog extends BaseStepDialog implements StepDialogInterface {
    ...
    public GisGroupByDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
